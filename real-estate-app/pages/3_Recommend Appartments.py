...
location_df_path = project_root / 'models' / 'location_distance.pkl'
cosine_sim1_path = project_root / 'models' / 'cosine_sim1.pkl'
cosine_sim2_path = project_root / 'models' / 'cosine_sim2.pkl'
cosine_sim3_path = project_root / 'models' / 'cosine_sim3.pkl'
